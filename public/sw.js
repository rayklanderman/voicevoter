...
const CACHE_NAME = 'voice-voter-v1';
const STATIC_CACHE = 'voice-voter-static-v1';
const DYNAMIC_CACHE = 'voice-voter-dynamic-v1';
...
self.addEventListener('push', (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification('Voice Voter', options)
  );
});
